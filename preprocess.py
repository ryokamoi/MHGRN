...
output_paths = {
    ...
    'csqa': {
        ...
        'paths': {
            ...
            'scores-rel-train': './data/csqa/paths/train.paths.scores.rels.jsonl',
            'scores-rel-dev': './data/csqa/paths/dev.paths.scores.rels.jsonl',
            'scores-rel-test': './data/csqa/paths/test.paths.scores.rels.jsonl',
    ...
    routines = {
        ...
        'csqa': [
            ...
            {'func': score_paths, 'args': (output_paths['csqa']['paths']['raw-train'], input_paths['transe']['ent'], input_paths['transe']['rel'],
                                           output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-train'], output_paths['csqa']['paths']['scores-rel-train'],
                                           args.nprocs)},
            {'func': score_paths, 'args': (output_paths['csqa']['paths']['raw-dev'], input_paths['transe']['ent'], input_paths['transe']['rel'],
                                           output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-dev'], output_paths['csqa']['paths']['scores-rel-dev'],
                                           args.nprocs)},
            {'func': score_paths, 'args': (output_paths['csqa']['paths']['raw-test'], input_paths['transe']['ent'], input_paths['transe']['rel'],
                                           output_paths['cpnet']['vocab'], output_paths['csqa']['paths']['scores-test'], output_paths['csqa']['paths']['scores-rel-test'],
                                           args.nprocs)},
